...
export const WORDS_BASE = [
  ...
  { id: 301, arabic: 'كِتَابٌ', transcription: 'kitaabun', russian: 'книга', translations: ['книга'], semanticGroup: 'Учёба и знания', type: WORD_TYPES.noun, lessonId: STRESS, root: 'ك ت ب' },
  ...
  { id: 306, arabic: 'جَدِيدٌ', transcription: 'jadiidun', russian: 'новый', translations: ['новый'], semanticGroup: 'Признаки', type: WORD_TYPES.noun, lessonId: STRESS, root: 'ج د د' },
  ...
  { id: 402, arabic: 'مُسْلِمَاتٌ', transcription: 'muslimaatun', russian: 'мусульманки', translations: ['мусульманки'], semanticGroup: 'Люди', type: WORD_TYPES.noun, lessonId: TA_MARBUTA, root: 'س ل م' },
  { id: 403, arabic: 'كَبِيرَةٌ', transcription: 'kabiiratun', russian: 'большая', translations: ['большая'], semanticGroup: 'Признаки', type: WORD_TYPES.noun, lessonId: TA_MARBUTA },
  { id: 404, arabic: 'فَرَاشَةٌ', transcription: 'faraashatun', russian: 'бабочка', translations: ['бабочка'], semanticGroup: 'Животные', type: WORD_TYPES.noun, lessonId: TA_MARBUTA },
  ...
  { id: 406, arabic: 'مُثْمِرَاتٌ', transcription: 'muthmiraatun', russian: 'плодоносящие / плодотворные, жен. мн. ч.', translations: ['плодоносящие', 'плодотворные'], semanticGroup: 'Признаки', type: WORD_TYPES.noun, lessonId: TA_MARBUTA },
  ...
  { id: 408, arabic: 'جَمْعِيَّةٌ', transcription: 'jam3iyyatun', russian: 'общество / ассоциация / организация', translations: ['общество', 'ассоциация', 'организация'], semanticGroup: 'Общество', type: WORD_TYPES.noun, lessonId: TA_MARBUTA },
  { id: 409, arabic: 'مَدْرَسَةٌ', transcription: 'madrasatun', russian: 'школа', translations: ['школа'], semanticGroup: 'Учёба и знания', type: WORD_TYPES.noun, lessonId: TA_MARBUTA, root: 'د ر س' },
  { id: 410, arabic: 'بَنَاتٌ', transcription: 'banaatun', russian: 'девочки / дочери', translations: ['девочки', 'дочери'], semanticGroup: 'Люди', type: WORD_TYPES.noun, lessonId: TA_MARBUTA },
  { id: 411, arabic: 'جَدِيدَةٌ', transcription: 'jadiidatun', russian: 'новая', translations: ['новая'], semanticGroup: 'Признаки', type: WORD_TYPES.noun, lessonId: TA_MARBUTA, root: 'ج د د' },
